 ...
 * StringMerger.java
 * 
 * Created Aug 25, 2006 11:31:47 AM
 * 
 ...
 * 02111-1307 USA
 * ===================================================================
 * $Id: StringMerger.java,v 1.1 2006/08/26 06:10:26 matt Exp $
 * ===================================================================
 */
...
public final class StringMerger {
	...
	private static final Logger LOG = Logger.getLogger(StringMerger.class);
	...
	/**
	 * Merge from a class loader resource, and return the merged output as a String.
	 * 
	 * <p>This method calls the {@link #mergeResource(ClassLoader, String, Object, String)}
	 ...
	 */
	public static String mergeResource(ClassLoader loader, String resourcePath, 
			Object data) throws IOException {
		return mergeResource(loader, resourcePath, data, "");
	}
	...
	public static String mergeResource(ClassLoader loader, String resourcePath, 
		...
		if ( LOG.isDebugEnabled() ) {
			LOG.debug("Merging " +resourcePath +" with " +data);
		}
		InputStream in = loader.getResourceAsStream(resourcePath);
		if ( in == null ) {
			throw new IOException("Resource not available: " +resourcePath);
		}
